window.customKey = document.getElementById('custom_key').value;
console.log(window.customKey);
var paramValue = document.getElementById('param_value').value;
var pairsCount = document.getElementById('pairs').value;
...
for (var i = 1; i <= pairsCount; i++) {
    ...
    if (custom_name.length > 0 && $(":.fieldName[value='" + name + "']").val() == undefined) {
        var div = $('<div class="fieldWrapper" id="fieldwrapper' + fieldCount + '">');
